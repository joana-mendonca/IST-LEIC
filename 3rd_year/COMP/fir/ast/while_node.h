...
namespace fir {
  ...
  public:
    inline while_node(int lineno, cdk::expression_node *condition, cdk::basic_node *doblock) :
        basic_node(lineno), _condition(condition), _doblock(doblock) {
    }

    inline while_node(int lineno, cdk::expression_node *condition, cdk::basic_node *doblock, cdk::basic_node *finallyblock) :
