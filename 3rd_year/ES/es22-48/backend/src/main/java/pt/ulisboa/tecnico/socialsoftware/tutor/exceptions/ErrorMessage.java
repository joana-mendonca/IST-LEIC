...
public enum ErrorMessage {
    ...
    DIFFICULT_QUESTION_IS_NULL("Can't add Difficult Question because it is null"),
    ...
    CANNOT_CLOSE_CURRENT_WEEK("Impossible to close current week"),

    //TODO possibly revert. Check if this is allowed, however! It's a fun way to do it.
