...
int inode_delete(int inumber) {
    ...
    if (inode_table[inumber].i_size > 0) {
        ...
        int current_file_block_size = ((int)inode_table[inumber].i_size / BLOCK_SIZE) + 1;
        ...
        if (current_file_block_size > 10) {
            ...
            void *indirect_refences_block = data_block_get(inode_table[inumber].i_data_block[10]);
            ...
            if (data_block_free(inode_table[inumber].i_data_block[10]) == -1) {
                return -1;
            }
        }
